## As of the 0.4.2 release, the ClaferChocoIG project is discontinued
The code from this project has been merged into the [chocosolver]() project.

ClaferChocoIG (deprecated)
==========================
...
`claferchocoig-0.4.2-jar-with-dependencies.jar` that is standalone and contains all the required dependencies,
and `claferchocoig-0.4.2.jar` that is not.
