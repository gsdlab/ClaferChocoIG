...
```sh
java -jar claferchocoig-0.3.6-jar-with-dependencies.jar --file=<file-name.cfr> <options>
```
...
`claferchocoig-0.3.6-jar-with-dependencies.jar` that is standalone and contains all the required dependencies, 
and `claferchocoig-0.3.6.jar` that is not.
